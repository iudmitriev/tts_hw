...
class DeepSpeech2Model(BaseModel):
    def __init__(self, n_feats, n_class, hidden_channels=32, gru_hidden_size=800, gru_num_layers=5, **batch):
        ...
        self.rnn = nn.GRU(input_size=hidden_channels*n_feats, hidden_size=gru_hidden_size, num_layers=gru_num_layers, batch_first=True)

        self.full = nn.Linear(in_features=gru_hidden_size, out_features=n_class)
